 ...
 */
import { File as BaseFile, DataBlock as BaseDataBlock, Category as BaseCategory, Column as BaseColumn, ValuePresence, UndefinedColumn } from '../Dictionary'
import * as FastNumberParsers from '../Utils/NumberParsers'
 ...
 */
export class DataBlock implements BaseDataBlock {
...
export class Category implements BaseCategory {
     ...
     */
    getColumn(name: string): BaseColumn {
...
import fastParseInt = FastNumberParsers.parseInt
import fastParseFloat = FastNumberParsers.parseFloat
